...
//  SneakersStroreUIKit
//
//  Created by Тулеби Берик on 05.06.2023.
//
...
extension AlertManager {
    ...
    public static func showInvalidrepPasswordeAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Password are not matching", message: "Please enter a valid password.")
    }
